...
Usage:
    python scanner.py [--server turtle-wow] [--realm nordanaar] [--faction mergedAh]
"""
...
class WowAuctionsScraper:
    ...
    def __init__(self, server: str = "turtle-wow", realm: str = "nordanaar", faction: str = "mergedAh"):
        self.server = server
        self.realm = realm
...
def main():
    ...
    parser.add_argument('--faction', default='mergedAh', help='Faction (alliance/horde/mergedAh)')
